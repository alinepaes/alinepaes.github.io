...
XMuR (eXplainable MUltilingual Reasoning) investigates how AI systems reason across different languages while making their decisions 
transparent and understandable. The project aims to develop methods for evaluating and improving multilingual 
reasoning, identifying linguistic biases, and producing clear explanations that users can trust.

<div class="row justify-content-sm-center">
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="/assets/img/p6.png" title="" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
